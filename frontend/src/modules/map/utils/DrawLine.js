...
export default async function(route) {
  ...
  return fetch(`https://api.mapbox.com/optimized-trips/v1/mapbox/driving-traffic/-0.5851639,51.4093628;${routesMap}?geometries=geojson&overview=full&access_token=${mapboxgl.accessToken}`)
  .then((response) => {
